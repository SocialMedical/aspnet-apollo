...
{
    public class ProfessionalController : Sic.Web.Mvc.Controllers.BaseController
    {
            ...
            int? insuranceInstitutionId = null, string professionalName = null)
        {
            ...
            {
                specializationId = db.Specializations.Get(p => p.IsDefault).SingleOrDefault().SpecializationId;
            ...
            HomeController.FillSearchCriteria(this, db, specializationId, cityId, insuranceInstitutionId, professionalName, true);
        ...
        public ActionResult SearchByDescription(string professionInPlural, string cityOrInsuranceInstitution = null)
        {
            ...
            var specialization = db.Specializations.Get(p => p.ProfessionInPlural == professionInPlural).SingleOrDefault();
            ...
            if (!string.IsNullOrEmpty(cityOrInsuranceInstitution))
            {
                ...
                var insurance = db.InsuranceInstitutions.Get(p =>
                ...
                {                    
                    var cityEntity = db.Cities.Get(p => p.Name == cityOrInsuranceInstitution).SingleOrDefault();
                    if(cityEntity!=null)
                        cityId = cityEntity.CityId;
                }
            }

            HomeController.FillSearchCriteria(this, db, specialization.SpecializationId, cityId, insuranceInstituitionId, null, true);            
        ...
        private List<Models.Pro.View.Professional> PrepareSearchResult(int? specializationId = null, int? cityId = null,
            int? insuranceInstitutionId = null, string professionalName = null)
        {            
            var result = db.Professionals.GetProfessionals(
                specializationId,
                cityId,
        ...
        public ActionResult ProfileOptions(int option)
        {
            ViewBag.ProfessionalOption = ((ProfessionalOption)option);
            Models.Pro.View.ProfessionalSummary summary = db.Professionals.GetPofessionalSummary(Sic.Apollo.Session.ProfessionalId);
        ...
        {
            var professionalEntity = db.Professionals.Get(p=>p.ProfessionalId == professionalId, includeProperties:
        ...
        {
            var office = db.ProfessionalOffices.Get(p => p.ContactLocationId == contactLocationId, includeProperties: "ContactLocationPictures").Single();
        ...
        {            
            ...
            Models.Pro.Professional professional = db.Professionals.Get(p => p.ProfessionalId == userId,
        ...
        {
            MultiSelectList specializationList = db.Specializations.
        ...
        public ActionResult Profile(Models.Pro.Professional professional, int[] specializationMultiSelect)
        {
            ...
            try
            {
                professionalUpdate = db.Professionals.Get(p => p.ProfessionalId == Sic.Apollo.Session.ProfessionalId,
                            includeProperties: "Contact,ProfessionalSpecializations").Single();
                ...
                {                    
                    db.ProfessionalSpecializations.Delete(delete);
                    ...
                    !professionalUpdate.ProfessionalSpecializations.Any(q => q.SpecializationId == p)))
                {
                    ...
                    db.ProfessionalSpecializations.Insert(profession);
                }
                ...
                {
                    User userProfessional = db.Users.GetByID(Sic.Apollo.Session.ProfessionalId);
        ...
        public ActionResult InsuranceInstitutionPlans(string message, string messageType)
        {
            ...
            var professional = db.Professionals.Get(p => p.ProfessionalId == professionalId, 
        ...
        {
            int professionalId = Sic.Apollo.Session.ProfessionalId;
            return PartialView(db.ProfessionalInsuranceInstitutionPlans.Get(p => p.ProfessionalId == professionalId, includeProperties: "InsuranceInstitutionPlan.InsuranceInstitution.Contact"));
        }
        ...
        public ActionResult EditInsuranceInstitutionPlans(string[] assignedPlans)
        {
            ...
            var professional = db.Professionals.Get(p => p.ProfessionalId == professionalId, includeProperties: "ProfessionalInsuranceInstitutionPlans").Single();
            ...
            foreach (var d in delete)
            {
                ...
                d.Professional = null;
                db.ProfessionalInsuranceInstitutionPlans.Delete(d);
            }
            ...
            var insuranceInstitutionPlans = db.InsuranceInstitutionPlans.Get(p=>
            ...
            foreach (var assigned in insuranceInstitutionPlans)
            {
                if (!professionalInsurancePlan.Contains(assigned.InsuranceInstitutionPlanId.ToString()))
                {
                    ...
                    db.ProfessionalInsuranceInstitutionPlans.Insert(insurance);
                }
            }
        ...
        private Models.Pro.View.AssignedInsuranceInstitutionPlan AssignedInsuranceInstitutionPlan(int professionalId)
        {
            ...
            var plans = db.InsuranceInstitutionPlans.Get(p => p.Active && p.InsuranceInstitution.Active, includeProperties: "InsuranceInstitution,InsuranceInstitution.Contact");            

            model.Professional = db.Professionals.GetByID(professionalId);

            var assignedPlans = new HashSet<int>(db.ProfessionalInsuranceInstitutionPlans.
        ...
        public ActionResult OfficeIndex()
        {
            ...
            var offices = db.ProfessionalOffices.Get(p => p.ProfessionalId == professionalId && p.Active, includeProperties: "ContactLocationPictures,City");
            SetMarkers(offices);           
        ...
        public ActionResult ProfessionalOfficeLocations()
        {
            ...
            var offices = db.ProfessionalOffices.Get(p => p.ProfessionalId == professionalId && p.Active);            
            SetMarkers(offices);
        ...
        {            
            ...
            {
                ViewBag.CityId = db.Cities.ToSelectList();
            ...
            {
                Models.Pro.ProfessionalOffice office = db.ProfessionalOffices.GetByID(contactLocationId.Value);
                ViewBag.CitiesSelectedList = db.Cities.ToSelectList(selected: p => p.CityId == office.CityId);
                return PartialView(office);
            }            
        }
        ...
        public ActionResult EditOffice(Models.Pro.View.ProfessionalOffice viewProfessionalOffice)
        {
            ...
            try
            {
                ...
                {
                    professionalOffice = db.ProfessionalOffices.GetByID(viewProfessionalOffice.ContactLocationId);
                }
                ...
                var city = db.Cities.Get(p => p.CityId == viewProfessionalOffice.CityId, includeProperties: "State").Single();

                professionalOffice.StateId = city.State.StateId;
                professionalOffice.CountryId = city.State.CountryId;

                if (insert)
                    db.ProfessionalOffices.Insert(professionalOffice);
                else
                    db.ProfessionalOffices.Update(professionalOffice);
        ...
        {
            var professionalOffice = db.ProfessionalOffices.GetByID(contactLocationId);
        ...
        {
            return View(db.ProfessionalOffices.Get(p => p.ContactLocationId == contactLocationId, includeProperties: "ContactLocationPictures").Single());
        }
        ...
        public ActionResult SchoolIndex()
        {
            int professionalId = Sic.Apollo.Session.ProfessionalId;
            ViewBag.ProfessionalId = professionalId;
            var schools = db.ProfessionalSchools.
                Get(p => p.ProfessionalId == professionalId);
        ...
        {            
            ...
            else if (professionalSchoolId != null)
            {
                ...
                return PartialView(db.ProfessionalSchools.GetByID(professionalSchoolId.Value));
            }
        ...
        public ActionResult EditSchool(ProfessionalSchool professionalSchool)
        {
            try
            {
                ...
                {
                    professionalSchoolUpdate = db.ProfessionalSchools.GetByID(professionalSchool.ProfessionalSchoolId);
                }
                ...
                if (insert)
                    db.ProfessionalSchools.Insert(professionalSchoolUpdate);
                else
                    db.ProfessionalSchools.Update(professionalSchoolUpdate);
        ...
        {            
            db.ProfessionalSchools.Delete(professionalSchoolId);
            db.Save();
        ...
        public ActionResult CommunityIndex()
        {
            ...
            var communities = db.ProfessionalCommunities.
                Get(p => p.ProfessionalId == professionalId);
        ...
        public ActionResult EditCommunity(int? professionalCommunityId = null, int? institutionId = null, string institutionName = null)
        {
            ...
            else if (professionalCommunityId != null)
            {
                ...
                return PartialView(db.ProfessionalCommunities.GetByID(professionalCommunityId.Value));
            }
        ...
        public ActionResult EditCommunity(ProfessionalCommunity professionalCommunity)
        {
            try
            {
                ...
                {
                    professionalCommunityUpdate = db.ProfessionalCommunities.GetByID(professionalCommunity.ProfessionalCommunityId);
                }
                ...
                if (insert)
                    db.ProfessionalCommunities.Insert(professionalCommunityUpdate);
                else
                    db.ProfessionalCommunities.Update(professionalCommunityUpdate);
        ...
        {
            db.ProfessionalCommunities.Delete(professionalCommunityId);
            db.Save();
        ...
        public ActionResult ExperienceIndex()
        {
            ...
            var experiences = db.ProfessionalExperiences.
                Get(p => p.ProfessionalId == professionalId);
        ...
        public ActionResult EditExperience(int? professionalExperienceId = null, int? institutionId = null, string institutionName = null)
        {
            ...
            else if (professionalExperienceId != null)
            {
                ...
                return PartialView(db.ProfessionalExperiences.GetByID(professionalExperienceId.Value));
            }
        ...
        public ActionResult EditExperience(ProfessionalExperience professionalExperience)
        {
            try
            {
                ...
                {
                    professionalExperienceUpdate = db.ProfessionalExperiences.GetByID(professionalExperience.ProfessionalExperienceId);
                }
                ...
                if (insert)
                    db.ProfessionalExperiences.Insert(professionalExperienceUpdate);
                else
                    db.ProfessionalExperiences.Update(professionalExperienceUpdate);
        ...
        {
            db.ProfessionalExperiences.Delete(professionalExperienceId);
            db.Save();
        ...
        {
            ViewBag.Size = size;
            return PartialView(professionals.Where(p => p.Latitude != null && p.Longitude != null));
        }
        ...
        {
            return db.ProfessionalOfficeSchedules.Get(p => p.ProfessionalOffice.ProfessionalId == professionalId && 
        ...
        public ActionResult EditOfficeSchedule(int? contactLocationId = null,int? professionalOfficeScheduleId = null)
        {
            ...
            {                
                ...
                schedule.ProfessionalOffice = db.ProfessionalOffices.Get(p=>p.ContactLocationId == contactLocationId.Value, includeProperties:"Professional").SingleOrDefault();
            }
            else
            {
                schedule = db.ProfessionalOfficeSchedules.Get(p=>p.ProfessionalOfficeScheduleId == professionalOfficeScheduleId, includeProperties: "ProfessionalOffice").SingleOrDefault();
            }
        ...
        public JsonResult EditOfficeSchedule(ProfessionalOfficeSchedule professionalOfficeSchedule)
        {
            try
            {
                ...
                if (insert)
                {
                    ...
                    db.ProfessionalOfficeSchedules.Insert(professionalOfficeScheduleUpdate);
                    //UpdateModel(professionalOfficeScheduleUpdate);                
                }
                else
                {
                    professionalOfficeScheduleUpdate = db.ProfessionalOfficeSchedules.GetByID(professionalOfficeSchedule.ProfessionalOfficeScheduleId);
                    db.ProfessionalOfficeSchedules.Update(professionalOfficeScheduleUpdate);
                    //UpdateModel(professionalOfficeScheduleUpdate);
                }
                ...
                db.Appointments.GenerateAppointments(professionalOfficeScheduleUpdate);
                db.Save();
                ...
                //    professionalOfficeSchedule.ProfessionalOffice = db.ProfessionalOffices.GetByID(professionalOfficeSchedule.ContactLocationId);
            }
            catch(Exception)
            {
                return new JsonResult()
        ...
        public ActionResult DeleteOfficeSchedule(int professionalOfficeScheduleId)
        {
            try
            {
                db.Appointments.DeleteScheduleAppointment(professionalOfficeScheduleId);
                db.ProfessionalOfficeSchedules.Delete(professionalOfficeScheduleId);
                db.Save();
        ...
        {
            return View(db.Professionals.GetProfessionalsPendingConfirmation());
        }
        ...
        {
            var user = db.Users.Get(p => p.UserId == professionalId, includeProperties:"Contact").Single();
        ...
        {
            var user = db.Users.Get(p => p.UserId == professionalId).Single();
        ...
        public ActionResult Team()
        {
            ...
            var professional = db.Professionals.Get(p => p.ProfessionalId == Sic.Apollo.Session.ProfessionalId,
        ...
        public ActionResult CreateTeam(User user)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    db.Contacts.Insert(professionalTeam.TeamUser.Contact);
                    db.Users.Insert(professionalTeam.TeamUser);
                    db.ProfessionalTeams.Insert(professionalTeam);
        ...
        {
            ViewBag.ProfessionalOption = ProfessionalOption.Team;
            ProfessionalTeam profesionalTeam = db.ProfessionalTeams.Get(p => p.ProfessionalId == Sic.Apollo.Session.ProfessionalId
        ...
        public ActionResult EditTeam(EditUserContact user)
        {
            ...
            ProfessionalTeam professionalTeamUpdate = db.ProfessionalTeams.Get(p => p.ProfessionalTeamId == user.ProfessionalTeamId,
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    db.ProfessionalTeams.Update(professionalTeamUpdate);
                    db.Users.Update(professionalTeamUpdate.TeamUser);
                    db.Contacts.Update(professionalTeamUpdate.TeamUser.Contact);
                    db.Save();
        ...
        public ActionResult DeleteTeam(int professionalTeamId)
        {
            ...
            try
            {
                ...
                //db.ProfessionalTeams.Delete(profesionalTeam);
                profesionalTeam.Active = false;
                profesionalTeam.TeamUser.Type = (int)UserType.Customer;

                db.ProfessionalTeams.Update(profesionalTeam);
                db.Users.Update(profesionalTeam.TeamUser);
                db.Save();
        ...
        public ActionResult ProfessionalRateList(int professionalId, bool resume = false)
        {
            ...
            return PartialView(db.AppointmentTransactions.GetRateAppointments(professionalId, resume));
        }
        ...
        public ActionResult ProfessionalCard(int? professionalId = null, int? contactLocationId = null, int? specializationId = null, bool showBookOnline = true, bool linkAvailable = true)
        {
            ...
            if (contactLocationId == null && specializationId == null)
                return PartialView(db.Professionals.GetProfessionals(professionalId).First());
            else 
                return PartialView(db.Professionals.GetProfessionals(professionalId: professionalId, contactLocationId: contactLocationId, specialityId: specializationId).First());
        }        
