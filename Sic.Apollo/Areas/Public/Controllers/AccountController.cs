...
namespace Sic.Apollo.Areas.Public.Controllers
{
    public class AccountController : Sic.Web.Mvc.Controllers.BaseController
    {
        ...
        {
            return PartialView("_LoginButton");
        }        
        ...
        {
            return PartialView("_Login",new SignIn()
                {
        ...
        {
            return PartialView("_LoginPopUp", new SignIn()
            {
        ...
        {            
            ...
            if (user != null)
            {
                ...
                {
                    location = Url.Action("Book", "Appointment", new { area = "Professional" });                    
                }
            ...
            {
                this.AddErrorMessage(Sic.Apollo.Resources.Resources.LabelForLoginFailed);
                ModelState.AddModelError("LogonName", message);
            }

            if (signIn.LoginFor == SignIn.LoginAction.PopUp)
            {                
                return Json(new { Success = isValid, Location = location });                
            }
        ...
        public ActionResult RegisterProfessional(User user)
        {
            ...
            Models.Pro.Professional professional = new Models.Pro.Professional();
